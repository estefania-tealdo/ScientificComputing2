...
def get_list_cell(r_c, neighbor_delta_coordinate, domain=1.0, a=1):
    ...
    side_length = r_c / a
    ############## Task 2 begins ################
    #TODO: not sure what list they want, this might not be right
    successorNdc = get_successor_neighbor_delta_coordinate(a)
    create_neighbor_cell_index(successorNdc, domain)
    list_cells.append(self.neighbor_cell_index)
